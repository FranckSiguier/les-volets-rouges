  ...
  return (
    <main className="flex w-full flex-col">
      ...
      <div className="align-center flex justify-center gap-8 text-center font-thin">
        <button
          className={`text-xl ${menuSection === "starter" ? "text-accent underline underline-offset-[4px]" : ""}`}
        ...
        <button
          className={`text-xl ${menuSection === "main" ? "text-accent underline underline-offset-[4px]" : ""}`}
